...
<head>
<meta charset="utf-8">
<title>Reciclaje Automático de Basura - Horas de Uso</title>
  ...
  <div class="container">
    <div class="row">
        <div class="col-md-12 text-center">
            <h3>Análisis de Objetos reciclados en un Día</h3>
        </div>
        <br>
        <div class="col-md-12">
            ...
            <script language="javascript">
                Highcharts.chart('container', {
                    ...
                    title: {
                        text: 'Promedio de Objetos depositados según la hora del día'
                    },
                    ...
                    series: [{
                        name: 'Objetos',
                        data: <?php echo json_encode($objetos)?>
                    }]
                });
            </script>
